...
DELETE FROM hoadon 
WHERE status = 2 
AND ngay_cap_nhat <= DATE_SUB(NOW(), INTERVAL 15 DAY)
";
...
<body>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            if ($row["status"] == 1) {
                                ...
                                echo "
    <a href='invoice_update.php?action=approve&id=" . $row["idhoadon"] . "' 
       style='color:blue;font-weight:bold'
       onclick='return confirm(\"Duyệt đơn này?\")'>✔ Duyệt</a> |

    <a href='invoice_update.php?action=cancel&id=" . $row["idhoadon"] . "' 
    ...
    <footer style="height: 50px; min-height: 50px; line-height: 50px; text-align: center">
        <div class="content-center">
            Hệ thống được bảo trợ bởi GÓC SÁCH NHỎ - Việt Nam | Mọi chi tiết liên hệ Admin Việt Dũng, Hotline:
            0355452903
        </div>
    </footer>
</body>
